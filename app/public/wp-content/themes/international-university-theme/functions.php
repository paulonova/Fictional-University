...
function university_files() {
  wp_enqueue_script('main-university-js', get_theme_file_uri('/js/scripts-bundled.js'), NULL, '1.0', true); /** Null = no dependencies, version, true = render bottom on the footer, not in header */
  ...
  wp_enqueue_style('university_main_styles', get_stylesheet_uri()); /** ('nickname', function that get ./style.css) */
}
