...
// Redirect only subscriber accounts out of admin and onto homepage
...
//Hide admin-bar from SUBSCRIBER users..
...
// allow Change the CSS style in LOGIN page
